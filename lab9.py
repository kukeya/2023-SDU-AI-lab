...
max_steps = 2000  # 最大迭代次数
learning_rate = 0.01  # 学习率
dropout = 0.9  # dropout时随机保留神经元的比例
data_dir = '/usr/local/AI_Trial_Data/tf_hand_writing/MNIST_DATA'  # 样本数据存储的路径
...
# summaries合并
merged = tf.compat.v1.summary.merge([tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.SUMMARIES, 'loss'),
                                     tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.SUMMARIES, 'accuracy')])
